...
<nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="<%=url1%>/index.jsp"> <img
                src="<%=url1%>/img/logo/logo.png"
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link active"
                                        aria-current="page" href="<%=url1%>/index.jsp">Trang chủ</a></li>
            ...
            <form class="d-flex" role="search" style="position: relative;display: block;float: right;">
                ...
                <%
                    ...
                    if(khachHang==null){
                %>
                <a class="btn btn-primary" style="white-space: nowrap;" href="<%=url1%>/khachhang/dangnhap.jsp">
                    Đăng nhập
                </a>
                <%} else { %>
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 bg-infor ">
                    <li class="nav-item dropdown dropstart"><a
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="<%=url1%>/khachhang/thaydoithongtin.jsp">Thay đổi thông tin</a></li>
                            <li><a class="dropdown-item" href="<%=url1%>/khachhang/doimatkhau.jsp">Đổi mật khẩu</a></li>
                            <li><hr class="dropdown-divider"></li>
